...
public class UserModel extends BaseModel {
     ...
     */
    User user = new User();
    public void register(String email,String username,String password, String pwdagain, final LogInListener listener) {
    ...
    public Boolean  queryUser(final String username){
